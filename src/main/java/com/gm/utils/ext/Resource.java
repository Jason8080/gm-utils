 ...
 * 资源文件加载工具类
 *
 * @author <a href="mailto:Jason@gm.com">Jason</a><br>
 */
public final class Resource {
    ...
    private synchronized static void load() {
        ...
        try {
            Class<?> threadClazz = Class.forName("com.gm.spring.helper.EnvironmentHelper");
    ...
    public static Properties getAllProperties(String prefix) {
        ...
        Set<Entry<Object, Object>> entrySet = allProperties.entrySet();
        for (Entry<Object, Object> entry : entrySet) {
            if (Bool.isBlank(prefix) || entry.getKey().toString().startsWith(prefix)) {
