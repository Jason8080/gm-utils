...
public class SimpleHttpAsyncClientDemo {  
     ...
     */  
    public static void send(String url, Map<String,String> map,final String encoding, final IHandler handler) throws KeyManagementException, NoSuchAlgorithmException, ClientProtocolException, IOException {
